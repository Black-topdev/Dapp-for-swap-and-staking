        ...
        >
          <div className="min-h-screen px-4 text-center">
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <Dialog.Overlay className="fixed inset-0 bg-dark-0 bg-opacity-70" />
            </Transition.Child>
            ...
            >
              <div
                ...
                } overflow-hidden align-middle transition-all transform rounded-20 bg-white dark:bg-black text-left`}
              >
