...
export const FiatBox = ({
  ...
  return (
    <div
      className={`${customClass} flex flex-col items-between bg-white dark:bg-dark-2 [h-360px] p-30 shadow hover:shadow-lg rounded-20 text-grey-4 dark:text-grey-0 lg:mt-0 mt-30`}
    >
      ...
      <div className="flex justify-between items-center my-20 max-w-[280px]">
        {fiatIn && (
          <a
            className="btn-primary bg-third hover:bg-third-light rounded w-[135px] h-[40px]"
            href={fiat.buyUrl}
            rel="noreferrer"
            target="_blank"
          >
