      ...
      <div className="space-y-15">
        ...
        <div>
          ...
          <div className="flex justify-between space-x-6">
              ...
              <button
                ...
                className={`w-full font-medium border border-grey-3 rounded-[12px] text-12 p-8 ${
                  currentSlippage === slippage
                    ? 'bg-third !border-third text-white'
                    : ''
                }`}
              >
                +{slippage * 100}%
            ...
            <input
              type="text"
              className={`w-[69px] dark:bg-black dark:focus:bg-third outline-none border border-grey-3 text-center text-12 rounded-[12px] ${
                currentSlippage === Number(customSlippage) / 100
                  ? 'bg-third text-white placeholder-white'
                  : ''
              }`}
              onFocus={() => {
