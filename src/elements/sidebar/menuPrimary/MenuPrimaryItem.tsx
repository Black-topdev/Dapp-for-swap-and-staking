  ...
  return (
    <>
      <NavLink
        ...
        exact
        strict
        activeClassName="text-third border-third"
        className={`flex items-center justify-between w-full text-16 text-white hover:text-third-light font-medium border-l-[5px] h-[44px] transition-all duration-500 ${
          isActive
            ? 'text-third border-third'
            : 'border-third-light border-l-[5px] hover:border-third'
        }`}
      >
